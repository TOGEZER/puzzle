...
class Envira_Review {
	...
	public function admin_footer( $text ) {
		...
		if ( !empty( $current_screen->id ) && strpos( $current_screen->id, 'envira' ) !== false ) {
			...
			$text = sprintf( __( 'Please rate <strong>Envira Gallery</strong> <a href="%s" target="_blank">&#9733;&#9733;&#9733;&#9733;&#9733;</a> on <a href="%s" target="_blank">WordPress.org</a> to help us spread the word. Thank you from the Envira Gallery team!', 'envira-gallery' ), $url, $url );
		}
		return $text;
	}
	...
	public function review() {
		...
		<div class="notice notice-info is-dismissible envira-review-notice">
			...
			<p><strong><?php _e( '~ Syed Balkhi<br>Co-Founder of Envira Gallery', 'envira-gallery' ); ?></strong></p>
			<p>
	...
	public static function get_instance() {
		...
		if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Envira_Review ) ) {
			self::$instance = new Envira_Review();
		}
...
$envira_lite_review = Envira_Review::get_instance();