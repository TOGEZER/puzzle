			...
			<dd>
				<label for="general-settings-feed-post-count">
					<input id="general-settings-feed-post-count" class="clearcache short" type="text"
					       ...
					       value="<?php echo (isset($options['general-settings-feed-post-count'])) ? (int)$options['general-settings-feed-post-count'] : defined('FF_FEED_POSTS_COUNT') ? FF_FEED_POSTS_COUNT : 100; ?>"/><div><div></div></div>
			</dd>
